...
local function run(msg, matches)
  if matches[1]:lower() == 'mutetime' or matches[1]:lower() == 'زمان بیصدا' and is_mod(msg) then
     local hash = 'mute_time:'..msg.chat_id_
  ...
  if matches[1]:lower() == 'unmutetime' or matches[1]:lower() == 'باصدا زمان' and is_mod(msg) then
     local hash = 'mute_time:'..msg.chat_id_
     redis:del(hash)
